 ...
 * Description: Accept payments via Razorpay in FluentCart - supports one-time payments, subscriptions, refunds, and multiple payment methods
 * Version: 1.0.0
 * Author: FluentCart
...
define('RAZORPAY_FC_VERSION', '1.0.0');
